<?php
/**
 * Import from Google Keep. The scan/preview/commit flow lives in assets/js/import.js.
 *
 * @var callable $e
...
<main class="import-page">
  ...
  <ol class="import-steps">
    <li>Go to <a href="https://takeout.google.com" target="_blank" rel="noopener">takeout.google.com</a>, click
      <strong>Deselect all</strong>, then check only <strong>Keep</strong>, and export.</li>
    <li>Download and unzip the export. Inside you'll find a <code>Takeout/Keep/</code> folder full of
      <code>.json</code> files (one per note) &mdash; each also has a matching <code>.html</code> file you can ignore.</li>
    <li>Below, select either that whole <code>.zip</code> (if this server has PHP's zip extension) or just the
      <code>.json</code> files directly, then scan them.</li>
